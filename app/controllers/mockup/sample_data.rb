module Mockup::SampleData
  GUAHAO_PATIENTS = [
    {name: '王大锤',   gender: '男', label: '普通预约'},
    {name: '张本煜',   gender: '男', label: '体检预约'},
    {name: '龚小爱',   gender: '女', label: '治疗预约'},
    {name: '孔连顺',   gender: '女', label: '体检预约'},
    {name: '张本煜',   gender: '男', label: '普通预约'},
    {name: '刘循子墨', gender: '男', label: '普通预约'},
    {name: '易小星',   gender: '男', label: '治疗预约'},
    {name: '夏一可',   gender: '女', label: '体检预约'},
    {name: '葛布',     gender: '女', label: '普通预约'},
    {name: '唐巍',     gender: '男', label: '体检预约'},
    {name: '孔晓婷',   gender: '女', label: '普通预约'},
    {name: '钱多多',   gender: '男', label: '体检预约'},
    {name: '许小桀',   gender: '男', label: '普通预约'},
    {name: '顾慎为',   gender: '男', label: '治疗预约'},
    {name: '韩颂',    gender: '男', label: '体检预约'},
    {name: '上官瑞',   gender: '女', label: '治疗预约'},
