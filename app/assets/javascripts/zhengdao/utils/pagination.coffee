@Pagination = React.createClass
  render: ->
    ...
    <div className="ui pagination menu small">
      <a className='item icon' href={first_href}><i className='icon step backward' /></a>
      <a className='item icon' href={prev_href}><i className='icon chevron left' /></a>
      ...
      <a className='item icon' href={next_href}><i className='icon chevron right' /></a>
      <a className='item icon' href={prev_href}><i className='icon step forward' /></a>
    </div>
