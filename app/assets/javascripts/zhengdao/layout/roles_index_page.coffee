@ManagerIndexPage = React.createClass
  render: ->
    <div className='manager-index-page'>
      <PageDesc text='你正以管理身份登录，你可以在此进行人员管理，查看患者档案，以及查看系统信息' />
...
@WizardIndexPage = React.createClass
  render: ->
    <div className='manager-index-page'>
      <PageDesc text='你正以导诊身份登录，你可以在此进行患者登记，调度挂号队列，以及查看资源状态' />
...
@DoctorIndexPage = React.createClass
  render: ->
    <div className='manager-index-page'>
      <PageDesc text='你正以医师身份登录，你可以在此处理患者就诊队列，安排诊疗环节和记录信息' />
...
@PeIndexPage = React.createClass
  render: ->
    <div className='manager-index-page'>
      <PageDesc text='你正以体检师身份登录，你可以在此处理患者治疗队列' />
...
@CureIndexPage = React.createClass
  render: ->
    <div className='manager-index-page'>
      <PageDesc text='你正以治疗师身份登录，你可以在此处理患者治疗队列' />
