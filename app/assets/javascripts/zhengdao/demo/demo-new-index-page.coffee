@DemoNewIndexPage = React.createClass
  getInitialState: ->
    period: 0
  render: ->
    <div className='demo-new-index-page'>
      <div ref='svg' className='svg-source' style={marginBottom: '1.5rem'}></div>
  ...
  componentDidMount: ->
    jQuery.ajax
      url: '/svg/demo.svg'
    .done (res)=>
      jQuery(ReactDOM.findDOMNode @refs.svg)
        .append jQuery(res).find('svg')
